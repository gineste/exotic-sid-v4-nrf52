...
void vCompilationInfoToTimestamp(uint32_t * p_pu32Timestamp)
{
   ...
   l_u8StrLengthDate = strlen(BUILD_DATE);
   l_u8StrLengthTime = strlen(BUILD_TIME);
   memcpy(l_pchDate, BUILD_DATE, l_u8StrLengthDate);
   memcpy(l_pchTime, BUILD_TIME, l_u8StrLengthTime);
